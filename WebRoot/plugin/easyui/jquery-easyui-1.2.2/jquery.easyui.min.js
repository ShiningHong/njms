...
if(_1af.options.modal==true){
	var iframeMask = $("<iframe class=\"iframe-mask\"></iframe>").css({width:(_1af.options.inline?_1af.mask.parent().width():_1b2().width),height:(_1af.options.inline?_1af.mask.parent().height():_1b2().height)});
	_1af.mask=$("<div class=\"window-mask\"></div>").css({width:(_1af.options.inline?_1af.mask.parent().width():_1b2().width),height:(_1af.options.inline?_1af.mask.parent().height():_1b2().height),display:"none"});
	iframeMask.appendTo(_1af.mask);
	_1af.mask.insertAfter(_1af.window);
}
if(_1af.shadow){
_1af.shadow.remove();
}
...
$(window).resize(function(){
	$("body>iframe.iframe-mask").css({width:$(window).width(),height:$(window).height()});
	$("body>div.window-mask").css({width:$(window).width(),height:$(window).height()});
	setTimeout(function(){
		$("body>iframe.iframe-mask").css({width:_1b2().width,height:_1b2().height});
